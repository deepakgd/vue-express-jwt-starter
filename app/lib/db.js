...
module.exports = function (mongoose) {
  ...
  const MONGO_URI = env === 'local' ? 'mongodb://localhost:27017/mg-motors'
    : `mongodb://${config.mongoUser}:${config.mongoPassword}@${config.mongoHost}/${config.dbname}?ssl=true&replicaSet=krds-sg-shard-0&authSource=admin`
